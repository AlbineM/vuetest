...
<template>
    <form v-if="filters" class="bg-white p-12 mb-6 shadow-lg grid grid-cols-4 gap-2 items-center rounded-lg relative" @focusin="isDropdownOpen = false">
        <div class="flex border-r-2 border-y-0 border-gray-200 items-center">
            <div class="xl:w-96">
        ...
        <div class="flex flex-col px-4 border-r-2 border-y-0 border-gray-200 h-full w-auto">
        ...
        <div class="px-4 flex gap-2 h-full border-r-2 border-y-0 border-gray-200 items-center">
